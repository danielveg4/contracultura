			...
			<div class="principal" id="central">
				...
				<div class="principal__sale">
					...
					<div href="" class="button">
						<a href="index_shop.php" class="button__text">Compralo aquí</a>
						<img src="../assets/img/carrito.png" alt="" />
					</div>
				</div>
				<div class="principal__articles">
					<a href="index_articulos.php" class="principal__articles__title">
						<h2>Artículos</h2>
					</a>
						...
						<div class="subarticle">
							<div class="subarticle__text">
								<div class="subarticle__title">
									...
									<a class="subarticle__link" href="art-wagner.php">Léelo aquí</a>
								</div>
							</div>
						...
						<img class="subarticle__img" src="../assets/img/tronti.jpg">
							<div class="subarticle__text">
								<div class="subarticle__title">
									...
									<p>Sergio Bologna</p>
									<a class="subarticle__link" href="art-tronti.php">Léelo aquí</a>
								</div>
							</div>
						</div>
						<div class="subarticle">
							<div class="subarticle__text">
								<div class="subarticle__title">
									...
									<a class="subarticle__link" href="art-alami.php">Léelo aquí</a>
								</div>
							</div>
							<img class="subarticle__img" src="../assets/img/ilias.png">
						</div>
					</div>
					<a href="index_articulos.php" class="principal__articles__more">
						<h2>Leer más</h2>
						<div class="principal__articles__underline"></div>
					</a>
				</div>
				<div class="principal__collections">
					<a href="paginas/index_colecciones.php" class="principal__collections__title">
						<h2>Colecciones</h2>
					</a>
					<div class="principal__collections__container">
						<div class="collection">
							<div class="collection__text">
								<a class="collection__link" href="index_shop.php">Marx XXI</a>
							</div>
						...
						<div class="collection">
							...
							<div class="collection__text">
								<a class="collection__link" href="index_shop.php">Cuadernos de Coyuntura</a>
							</div>
						</div>
						<div class="collection">
							<div class="collection__text">
								<a class="collection__link" href="index_shop.php">Ecología</a>
							</div>
