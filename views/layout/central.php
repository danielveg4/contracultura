			...
			<div class="principal" id="central">
				<div class=principal__news>
					<div class="article">
						<img class="article__img" src="<?=base_url?>assets/img/kautsky.jpeg" />
						<div class="article__info">
							<a class="article__link" href="<?=base_url?>paginas/art-kautsky.php">Kautsky, el socialismo y la teoría del valor (comentario)</a>
					...
					<div class="article">
						<img class="article__img" src="<?=base_url?>assets/img/biden.jpeg" />
						<div class="article__info">
							<a class="article__link" href="<?=base_url?>paginas/art-neokeyneisianismo.php">Las consecuencias económicas del neokeynesianismo</a>
					...
					<div class="article">
						<div class="article__info">
							<a class="article__link" href="<?=base_url?>paginas/art-meiksinswood.php">La separación entre economía y política en Ellen Meiksins Wood</a>
				...
				<div class="principal__sale">
					...
					<div href="" class="button">
						<a href="<?=base_url?>paginas/index_tienda.php" class="button__text">Compralo aquí</a>
						<img src="<?=base_url?>assets/img/carrito.png" alt="" />
					</div>
				</div>
				<div class="principal__articles">
					<a href="<?=base_url?>index.php" class="principal__articles__title">
						<h2>Artículos</h2>
					</a>
						...
						<div class="subarticle">
							<div class="subarticle__text">
								<div class="subarticle__title">
									...
									<a class="subarticle__link" href="<?=base_url?>paginas/art-wagner.php">Léelo aquí</a>
								</div>
							</div>
						...
						<img class="subarticle__img" src="<?=base_url?>assets/img/tronti.jpg">
							<div class="subarticle__text">
								<div class="subarticle__title">
									...
									<p>Sergio Bologna</p>
									<a class="subarticle__link" href="<?=base_url?>paginas/art-tronti.php">Léelo aquí</a>
								</div>
							</div>
						</div>
						<div class="subarticle">
							<div class="subarticle__text">
								<div class="subarticle__title">
									...
									<a class="subarticle__link" href="<?=base_url?>paginas/art-alami.php">Léelo aquí</a>
								</div>
							</div>
							<img class="subarticle__img" src="<?=base_url?>assets/img/ilias.png">
						</div>
					</div>
					<a href="<?=base_url?>paginas/index_articulos.php" class="principal__articles__more">
						<h2>Leer más</h2>
