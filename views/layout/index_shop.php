					...
					<div class="shop__collection-container">
						<div class="collection-white">
							<div class="collection__text-white">
								<a class="collection__link-white" href="<?=base_url?>carrito/add&id=<?=$product->id?>">Marx XXI</a>
							</div>
							<img class="collection__img" src="<?=base_url?>assets/img/marx1.jpg">
						</div>
						<div class="shop__collection-details">
							...
							<p class="shop__collection-price">7 euros / unidad</p>
							<a href="<?=base_url?>carrito/add&id=<?=$product->id?>" class="shop__collection-button">Resérvalo aquí</a>
						</div>
					</div>
					<div class="shop__collection-container">
						<div class="collection-white">
							<div class="collection__text-white">
								<a class="collection__link-white" href="<?=base_url?>carrito/add&id=<?=$product->id?>">Cuadernos de Coyuntura</a>
							</div>
							<img class="collection__img" src="<?=base_url?>assets/img/coyuntura.jpg">	
						</div>
						<div class="shop__collection-details">
							...
							<p class="shop__collection-price">8 euros / unidad</p>
							<a href="<?=base_url?>carrito/add&id=<?=$product->id?>" class="shop__collection-button">Resérvalo aquí</a>
						</div>
					</div>
					<div class="shop__collection-container">
						<div class="collection-white">
							<div class="collection__text-white">
								<a class="collection__link-white" href="<?=base_url?>carrito/add&id=<?=$product->id?>">Ecología</a>
							</div>
							<img class="collection__img" src="<?=base_url?>assets/img/ecologia.png">
						</div>
						<div class="shop__collection-details">
